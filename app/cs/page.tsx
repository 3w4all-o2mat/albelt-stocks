...
import CsCutsTable from "@/components/cuts/CsCutsTable";
...
export default async function CSPage({
  ...
  const [cuts, deleteHours] = await Promise.all([
    getCutsByType("CS", { atelier, allowedAteliers: allowedNames }),
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-2">
      ...
      <Card className="mt-6">
        <CardHeader
          title="Toutes les chutes stockées"
          subtitle="Coupes de type CS enregistrées"
